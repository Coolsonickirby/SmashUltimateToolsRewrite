...
<body>
    ...
    <div class="header-desktop">
        ...
        <img src="./img/front-page/tools_header.webp" alt="Smash Ultimate Tools" style="width: 100%; cursor: pointer;" onclick="openTab(event, 'Main', 'grid')" id="main-header-img" />
        <div class="tab">
            <div class="button-parent">
    ...
    <div class="main">
        <div class="main">
            ...
            <div class="grid-container tabcontent" id="Main">
                <img src="./img/front-page/tools_audio.webp" alt="Audio" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=audio">
                <img src="./img/front-page/tools_css.webp" alt="CSS Editor" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=prcChara&id=prcChara">
                <img src="./img/front-page/tools_sss.webp" alt="SSS Editor" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=prcStage&id=prcStage">
                <img src="./img/front-page/tools_fpe.webp" alt="Fighter Param Editor" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=prcFighterParam&id=prcFighterParam">
                <img src="./img/front-page/tools_msbt.webp" alt="MSBT Editor" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=msbtEditor">
                <img src="./img/front-page/tools_cce.webp" alt="Color Common Editor" onclick="window.location.href = this.getAttribute('data-href')" data-href="./index.php?page=prcColorCommon&id=prcColorCommon">
            </div>
            ...
            <div id="Credits" class="tabcontent">
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        <h4>
                            <a href="./">This Website</a> - <a href="https://github.com/coolsonickirby/">Coolsonickirby</a>
                        </h4>
                        <h4>
                ...
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        ...
                        <h4><a href="./index.php?page=msbtEditor">MSBTEditor Web Interface</a> - <a href="https://github.com/Coolsonickirby/">Coolsonickirby/Random</a></h4>
                    </div>
                </div>
                <br>
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        ...
                        <h4><a href="./index.php?page=prcChara&id=prcChara">CSS Editor Web Interface</a> - <a href="https://github.com/Coolsonickirby/">Coolsonickirby/Random</a></h4>
                    </div>
                </div>
                <br>
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        <h4><a href="https://github.com/BenHall-7/paracobNET">ParamXML</a> - <a href="https://github.com/BenHall-7">Ben Hall</a></h4>
                        <h4><a href="https://github.com/lukasoppermann/html5sortable">html5sortable</a> - <a href="https://github.com/lukasoppermann">Lukas Oppermann</a></h4>
                        <h4><a href="http://www.dhtmlgoodies.com/scripts/form_widget_editable_select/form_widget_editable_select.html">Editable
                        ...
                        <h4><a href="./index.php?page=prcStage&id=prcStage">Stage Editor Web Interface</a> - <a href="https://github.com/Coolsonickirby/">Coolsonickirby/Random</a></h4>
                    </div>
                </div>
                <br>
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        <div class="msbt_credits">
                            <h4><a href="https://github.com/BenHall-7/paracobNET">ParamXML</a> - <a href="https://github.com/BenHall-7">Ben Hall</a></h4>
                            <h4><a href="./index.php?page=prcFighterParam&id=prcFighterParam">Fighter Param Editor Web
                ...
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        ...
                        <h4><a href="./index.php?page=skinConverter">Minecraft Java Skin Converter Web
                ...
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        <ol style="line-height: 2;">
                            ...
                            <li>Click on the song name, then click "Download BRSTM" (blue box in image below). <span class="strike">Make sure you note down everything in the highlighted section.</span> Not
                                necessary anymore.<br><img src="./img/mini1.png" alt="Download BRSTM" style="height:512px; width:auto;"></li>
                            <li>Go to <a href="./index.php?page=audio#music">"Music file"</a> and select the
                                brstm file you downloaded</li>
                            <li>Enable the <a href="./index.php?page=audio#loop">"Loop Samples"</a> checkbox
                            </li>
                ...
                <div class="button-parent button-block">
                    ...
                    <div class="content">
                        <p>The website stores the file, then uses shell_exec to convert the file to lopus/idsp (if
                            ...
                            then use shell_exec with SoX to resample the audio file, then return it. <span class="strike">Right now,
