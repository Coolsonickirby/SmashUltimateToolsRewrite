...
<body>
    ...
    <form method="post" action="./index.php?page=openPRC&source=prcChara" enctype="multipart/form-data" id="openForm">
        <input name="fileInput" id='fileInput' type='file' accept=".prc" hidden />
    </form>

    <form method="post" action="./index.php?page=savePRC&source=prcChara&outputName=ui_chara_db.prc" enctype="multipart/form-data" id="saveForm">
    ...
    <div class="buttons">
        ...
        <div class="button-parent">
            <a href="./index.php?page=prcChara&id=prcChara"><button class="tablinks load-default">Load Default</button></a>
        </div>
    </div>

    <div style="text-align: center; font-weight: bold;">
        <span>The saved file <span style="color: orangered;">ui_chara_db.prc</span> goes in <span style="color: blue;">ui/param/database/</span></span>
    </div>
    <hr style="width: 80%;">
