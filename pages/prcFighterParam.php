...
<body>
    ...
    <form method="post" action="./index.php?page=openPRC&source=prcFighterParam" enctype="multipart/form-data" id="openForm">
        <input name="fileInput" id='fileInput' type='file' accept=".prc" hidden />
    </form>

    <form method="post" action="./index.php?page=savePRC&source=prcFighterParam&outputName=fighter_param.prc" enctype="multipart/form-data" id="saveForm">
    ...
    <div style="text-align: center; font-weight: bold;">
        <span>The saved file <span style="color: orangered;">fighter_param.prc</span> goes in <span style="color: blue;">fighter/common/param</span></span>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="buttons">
                        <div class="button-parent">
                            <button type="button" class="btn btn-secondary" onclick="HideModal('randomizeOptions')">Close</button>
                        </div>
                        <div class="button-parent">
    ...
    <div class="modal" id="options">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="button-parent">
                        <button type="button" class="btn btn-secondary" onclick="HideModal('options')">Close</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal" id="shuffler">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="button-parent">
                        <button type="button" class="btn btn-secondary" onclick="HideModal('shuffler')">Close</button>
                    </div>
                    <div class="button-parent">
