...
<body>
    ...
    <form method="post" action="./index.php?page=openPRC&source=prcStage" enctype="multipart/form-data" id="openForm">
        <input name="fileInput" id='fileInput' type='file' accept=".prc" hidden />
    </form>

    <form method="post" action="./index.php?page=savePRC&source=prcStage&outputName=ui_stage_db.prc" enctype="multipart/form-data" id="saveForm">
    ...
    <div style="text-align: center; font-weight: bold;">
        <span>The saved file <span style="color: orangered;">ui_stage_db.prc</span> goes in <span style="color: blue;">ui/param/database/</span></span>
    </div>
